...
import static Login.LoginDAO.isMejaTersedia;
...
public class LoginCustomer extends javax.swing.JPanel {
    ...
    private void btnMasukActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnMasukActionPerformed
        String pelangganId = generatePelangganId();        
        ...
        // Validasi nomor meja sebagai angka
        int noMeja;
        try {
            noMeja = Integer.parseInt(NoMeja);
        } catch (NumberFormatException e) {
            JOptionPane.showMessageDialog(this, "Nomor meja harus berupa angka.", "Error", JOptionPane.ERROR_MESSAGE);
            return;
        }

        // Validasi (misalnya, meja tidak tersedia)
        if (isMejaTersedia(noMeja)) {
            JOptionPane.showMessageDialog(this, "Pelanggan berhasil terdaftar.", "Sukses", JOptionPane.INFORMATION_MESSAGE);
        
            // Simpan data pelanggan
            if (LoginDAO.tambahPelanggan(pelangganId, username, noMeja)) {
                // Buka halaman utama pelanggan
            ...
            JOptionPane.showMessageDialog(this, "Meja tidak tersedia.", "Error", JOptionPane.ERROR_MESSAGE);
        }
